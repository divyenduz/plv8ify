...
var plv8ify = (() => {
  ...
  function Header({ children }) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children });
  }
  function component(text) {
    return import_server.default.renderToStaticMarkup(
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Header, { children: "Hello" }),
        " ",
        text
      ] })
    );
